...
describe TwitterAPI::Geo::Polygon do

  before do
    @polygon = TwitterAPI::Geo::Polygon.new(:coordinates => [[[-122.40348192, 37.77752898], [-122.387436, 37.77752898], [-122.387436, 37.79448597], [-122.40348192, 37.79448597]]])
  end

  describe "#==" do
    it "returns false for empty objects" do
      polygon = TwitterAPI::Geo::Polygon.new
      other = TwitterAPI::Geo::Polygon.new
    ...
    it "returns false when objects coordinates are different" do
      other = TwitterAPI::Geo::Polygon.new(:coordinates => [[[37.77752898, -122.40348192], [37.77752898, -122.387436], [37.79448597, -122.387436], [37.79448597, -122.40348192]]])
      expect(@polygon == other).to be_false
    end
