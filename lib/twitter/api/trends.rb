...
module TwitterAPI
  module API
    module Trends
      ...
      # @param id [Integer] The {https://developer.yahoo.com/geo/geoplanet Yahoo! Where On Earth ID} of the location to return trending information for. WOEIDs can be retrieved by calling {TwitterAPI::API::Trends#trend_locations}. Global information is available by using 1 as the WOEID.
      ...
      def trends(id=1, options={})
        ...
        objects_from_array(TwitterAPI::Trend, response[:body].first[:trends])
      end
